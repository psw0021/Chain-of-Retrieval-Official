...
use_aspect_aware_cache_for_selection=True
...
if [ ${use_trained_model} == True ]; then
    ...
    method_agent_model_path="Models/Preference_Set_Llama-3.2-3B-Instruct_BGE_ref_as_gt_True_IterRet_individual_recall_True_top_k_30/meta-llama/Llama-3.2-3B-Instruct/method_agent/merged_model"
    experiment_agent_model_path="Models/Preference_Set_Llama-3.2-3B-Instruct_BGE_ref_as_gt_True_IterRet_individual_recall_True_top_k_30/meta-llama/Llama-3.2-3B-Instruct/experiment_agent/merged_model"
    research_question_agent_model_path="Models/Preference_Set_Llama-3.2-3B-Instruct_BGE_ref_as_gt_True_IterRet_individual_recall_True_top_k_30/meta-llama/Llama-3.2-3B-Instruct/research_question_agent/merged_model"
...
for i in {2..2}; do
    echo "Iteration $i"
    iteration=$i
    current_start=267  # Reset for each iteration
