...
benchmark_directory="Existing_Benchmarks/SciDocs_Final_Benchmark_w_Full_Paper/Final_Dataset_w_citations_mentions_removed/Benchmark/scidocs_cocite"
embedding_model="inf-retriever-v1-1.5b"
top_k=10
max_top_k=10
use_RRF_for_chunked_baseline=False
hyperparameter_RRF=60
corpus_directory="Existing_Benchmarks/SciDocs_Final_Benchmark_w_Full_Paper/Final_Dataset_w_citations_mentions_removed/Target_Corpus/target_corpus_citations_removed_True_mentions_removed_True/corpus.json"
batch_size=1
...
function run_job() {
    ...
    local job_num=$3
    local iteration=$4
    echo "Running inference_retrieval_SciDocs_Full.py"
    rm logs/logs_SciDocs_Full/output_${job_num}.log 
    python Inference/inference_retrieval_SciDocs_Full.py \
    ...
    --selector_starting_idx ${selector_starting_idx} > logs/logs_SciDocs_Full/output_${job_num}.log 2>&1
}
