...
root_directory = ""
result_directories = return_immediate_subdirectory(root_directory)

for current in result_directories:
    total_recall_10 = 0
    total_recall_5 = 0
    total_recall_3 = 0
    total_recall_1 = 0
    ...
    print(f"Current number of test sets is {number_of_test_sets}")
