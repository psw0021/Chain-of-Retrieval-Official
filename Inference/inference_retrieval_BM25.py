...
from Retrieval.retriever_BM25 import Retriever
...
def config():
    ...
    parser.add_argument("--retrieval_method", default="rank-BM25", choices=["rank-BM25"])
...
def evaluate(args):
    ...
    if args.use_full_paper_as_query == False:
        result_folder_name = f"{last_two_dirs}/remove_citations_{args.remove_citations}_remove_mentions_{args.remove_mentions}/No_QueryOptimizers/{args.retrieval_method}_top_{args.top_k}_use_chunked_{args.chunk_unit}_{args.use_chunked}_use_full_paper_as_corpus_{args.use_full_paper_as_corpus}/iteration_{args.iteration_num}"
